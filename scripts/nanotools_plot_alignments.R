...
data_coverage_twod_filename <- paste(basename, "/", sample, "/analysis/", refid, "_2D_coverage.txt", sep="");
data_coverage_template_filename <- paste(basename, "/", sample, "/analysis/", refid, "_Template_coverage.txt", sep="");
data_coverage_complement_filename <- paste(basename, "/", sample, "/analysis/", refid, "_Complement_coverage.txt", sep="");
data_perfect_cumulative_twod_filename <- paste(basename, "/", sample, "/analysis/", refid, "_2D_cumulative_perfect_kmers.txt", sep="");
data_perfect_cumulative_template_filename <- paste(basename, "/", sample, "/analysis/", refid, "_Template_cumulative_perfect_kmers.txt", sep="");
data_perfect_cumulative_complement_filename <- paste(basename, "/", sample, "/analysis/", refid, "_Complement_cumulative_perfect_kmers.txt", sep="");
data_perfect_best_twod_filename <- paste(basename, "/", sample, "/analysis/", refid, "_2D_best_perfect_kmers.txt", sep="");
data_perfect_best_template_filename <- paste(basename, "/", sample, "/analysis/", refid, "_Template_best_perfect_kmers.txt", sep="");
data_perfect_best_complement_filename <- paste(basename, "/", sample, "/analysis/", refid, "_Complement_best_perfect_kmers.txt", sep="");
data_gc_filename <- paste(basename, "/", sample, "/analysis/", refid, "_gc.txt", sep="");
