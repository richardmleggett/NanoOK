...
data_coverage_twod <- paste(basename, "/", sample, "/analysis/", refid, "_2D_coverage.txt", sep="");
data_coverage_template <- paste(basename, "/", sample, "/analysis/", refid, "_Template_coverage.txt", sep="");
data_coverage_complement <- paste(basename, "/", sample, "/analysis/", refid, "_Complement_coverage.txt", sep="");
data_perfect_cumulative_twod <- paste(basename, "/", sample, "/analysis/", refid, "_2D_cumulative_perfect_kmers.txt", sep="");
data_perfect_cumulative_template <- paste(basename, "/", sample, "/analysis/", refid, "_Template_cumulative_perfect_kmers.txt", sep="");
data_perfect_cumulative_complement <- paste(basename, "/", sample, "/analysis/", refid, "_Complement_cumulative_perfect_kmers.txt", sep="");
...
pdf_coverage_complement <- paste(basename, "/", sample, "/graphs/", refid, "_Complement_coverage.pdf", sep="");
pdf_perfect_cumulative_twod <- paste(basename, "/", sample, "/graphs/", refid, "_2D_cumulative_perfect_kmers.pdf", sep="");
pdf_perfect_cumulative_template <- paste(basename, "/", sample, "/graphs/", refid, "_Template_cumulative_perfect_kmers.pdf", sep="");
pdf_perfect_cumulative_complement <- paste(basename, "/", sample, "/graphs/", refid, "_Complement_cumulative_perfect_kmers.pdf", sep="");
...
data_perfect_cumulative_twod = read.table(data_perfect_cumulative_twod, col.name=c("Size", "n", "Perfect"))
...
data_perfect_cumulative_template = read.table(data_perfect_cumulative_template, col.name=c("Size", "n", "Perfect"))
...
data_perfect_cumulative_complement = read.table(data_perfect_cumulative_complement, col.name=c("Size", "n", "Perfect"))
