...
ggplot(data_coverage_twod, aes(x=data_coverage_twod$Position, y=data_coverage_twod$Coverage)) + geom_line() + ggtitle("2D coverage") + theme(text = element_text(size=10)) + xlab("Position") + ylab("Mean coverage for bin") + theme(plot.margin = unit(c(0.2,0.2,0.2,0.2), "cm")) + theme(axis.title.y=element_text(vjust=0.2)) + theme(axis.title.x=element_text(vjust=-0.2)) + expand_limits(y = 0)
garbage <- dev.off()
...
ggplot(data_coverage_template, aes(x=data_coverage_template$Position, y=data_coverage_template$Coverage)) + geom_line() + ggtitle("Template coverage") + theme(text = element_text(size=10)) + xlab("Position") + ylab("Mean coverage for bin") + theme(plot.margin = unit(c(0.2,0.2,0.2,0.2), "cm")) + theme(axis.title.y=element_text(vjust=0.2)) + theme(axis.title.x=element_text(vjust=-0.2)) + expand_limits(y = 0)
garbage <- dev.off()
...
ggplot(data_perfect_cumulative_twod, aes(x=data_perfect_cumulative_twod$Size, y=data_perfect_cumulative_twod$Perfect)) + geom_bar(stat="identity") + ggtitle("2D - cumulative perfect kmers") + theme(text = element_text(size=10)) + xlab("kmer size") + ylab("% reads with perfect kmer") + theme(plot.margin = unit(c(0.2,0.2,0.2,0.2), "cm")) + theme(axis.title.y=element_text(vjust=0.2)) + theme(axis.title.x=element_text(vjust=-0.2)) + scale_x_continuous(limits=c(0, 120)) + theme(text = element_text(size=8))
garbage <- dev.off()
...
ggplot(data_perfect_best_twod, aes(x=data_perfect_best_twod$Size, y=data_perfect_best_twod$Perfect)) + geom_bar(stat="identity") + ggtitle("2D - best perfect kmer") + theme(text = element_text(size=10)) + xlab("best perfect kmer") + ylab("% reads") + theme(plot.margin = unit(c(0.2,0.2,0.2,0.2), "cm")) + theme(axis.title.y=element_text(vjust=0.2)) + theme(axis.title.x=element_text(vjust=-0.2)) + scale_x_continuous(limits=c(0, 120)) + theme(text = element_text(size=8))
garbage <- dev.off()
