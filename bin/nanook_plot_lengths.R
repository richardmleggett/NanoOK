...
for (t in 1:3) {
    ...
    if (format=="png") {
        lengths_png <- paste(sampledir, "/graphs/", "all_",type,"_lengths.png", sep="");
        ...
        lengths_pdf <- paste(sampledir, "/graphs/", "all_",type,"_lengths.pdf", sep="");
    ...
    filename_kmers <- paste(sampledir, "/analysis/", "all_",type,"_kmers.txt", sep="");
    data_alignments = read.table(filename_kmers, header=TRUE)

    if (format=="png") {
        kmers_png <- paste(sampledir, "/graphs/", "all_",type,"_21mers.png", sep="");
        ...
        kmers_pdf <- paste(sampledir, "/graphs/", "all_",type,"_21mers.pdf", sep="");
